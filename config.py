...
class Settings:
    ...
    entry_atr_buffer_mult: float = float(os.getenv("BOT_ENTRY_ATR_BUFFER_MULT", "0.3"))
    entry_spread_buffer_mult: float = float(os.getenv("BOT_ENTRY_SPREAD_BUFFER_MULT", "2.0"))
