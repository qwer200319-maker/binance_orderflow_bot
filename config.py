...
class Settings:
    ...
    htf_ema_flat_ratio: float = float(os.getenv("BOT_HTF_EMA_FLAT_RATIO", "0.0003"))
    htf_allow_pullback_bias: bool = os.getenv("BOT_HTF_ALLOW_PULLBACK_BIAS", "true").lower() == "true"
