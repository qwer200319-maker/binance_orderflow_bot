...
class Settings:
    ...
    htf_ema_length: int = int(os.getenv("BOT_HTF_EMA_LENGTH", "55"))
    ...
    entry_atr_buffer_mult: float = float(os.getenv("BOT_ENTRY_ATR_BUFFER_MULT", "0.1"))
    ...
    sl_volatility_atr_mult: float = float(os.getenv("BOT_SL_VOLATILITY_ATR_MULT", "0.8"))
